...
void studentManagementMenu()
{
    ...
    do
    {
        ...
        printf("\t| 3. Edit thong tin sinh vien        n           |\n");
...
void sortStudentListAZ()
{
    ...
    FILE *file = fopen("C:\\project cua Tru\\Project\\data\\Student_Data.bin", "rb");
    if (file == NULL)
    {
...
bool isValidEmail(char email[])
{
    ...
    return at && dot && at < dot && strlen(email) <= 30;
}
...
int isValidStudentInfo(char *emailToCheck, char *phoneNumberToCheck)
{
    ...
    FILE *inputFile = fopen("C:\\project cua Tru\\Project\\data\\Student_Data.bin", "rb");
    if (inputFile == NULL)
    {
...
void showStudentList()
{
    ...
    outputFile = fopen("C:\\project cua Tru\\Project\\data\\Student_Data.bin", "rb");
    if (outputFile == NULL)
    {
...
void addNewStudent()
{
    ...
    inputFile = fopen("C:\\project cua Tru\\Project\\data\\Student_Data.bin", "ab");
    if (inputFile == NULL)
    {
    ...
    do
    {
        ...
        scanf("%20s", newstudentInfo.studentEmail);
        getchar();
    ...
    while (fread(&studentInfo, sizeof(struct Student), 1, file))
    {
        if (strcmp(studentInfo.studentID, IDToSearch) == 0)
        {
            ...
            do
            {
                ...
                scanf("%20s", studentInfo.studentEmail);
...
void deleteStudent()
{
    ...
    {
        if (remove("C:\\project cua Tru\\Project\\data\\Student_Data.bin") == 0 &&
            rename("C:\\project cua Tru\\Project\\data\\Temp_Student_Data.bin", "C:\\project cua Tru\\Project\\data\\Student_Data.bin") == 0)
        {
